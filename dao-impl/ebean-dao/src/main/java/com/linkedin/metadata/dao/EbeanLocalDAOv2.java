...
public class EbeanLocalDAOv2<ASPECT_UNION extends UnionTemplate, URN extends Urn>
  ...
  private final IEBeanLocalAccess _localAccess;
  ...
  protected <ASPECT extends RecordTemplate> AspectEntry<ASPECT> getLatest(@Nonnull URN urn,
    ...
    final EbeanMetadataAspect latest = batchGetUnion(
        Collections.singletonList(new AspectKey<>(aspectClass, urn, 0L)), 1, 0).get(0);
