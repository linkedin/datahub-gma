 ...
 */
@Slf4j
public class EbeanLocalDAOv2<ASPECT_UNION extends UnionTemplate, URN extends Urn>
  ...
  @VisibleForTesting
  EbeanLocalDAOv2(@Nonnull Class<ASPECT_UNION> aspectUnionClass, @Nonnull BaseMetadataEventProducer producer,
   ...
   */
  public EbeanLocalDAOv2(@Nonnull Class<ASPECT_UNION> aspectUnionClass, @Nonnull BaseMetadataEventProducer producer,
  ...
  @VisibleForTesting
  EbeanLocalDAOv2(@Nonnull BaseMetadataEventProducer producer, @Nonnull EbeanServer server,
   ...
   */
  public EbeanLocalDAOv2(@Nonnull BaseMetadataEventProducer producer, @Nonnull ServerConfig serverConfig,
      @Nonnull LocalDAOStorageConfig storageConfig, @Nonnull Class<URN> urnClass,
      @Nonnull UrnPathExtractor<URN> urnPathExtractor) {
  ...
  public <ASPECT extends RecordTemplate> void updateLocalIndex(@Nonnull URN urn, @Nonnull ASPECT newValue,
      long version) {
    log.error("Calling updateLocalIndex (a local secondary index related method) from EbeanLocalDAOv2,"
        + "which does not support local secondary index.");
  ...
  protected <ASPECT extends RecordTemplate> void save(@Nonnull URN urn, @Nullable RecordTemplate value,
    ...
    // upsert into old schema to be used as a change log
    if (insert) {
      _server.insert(aspect);
    } else {
  ...
  protected void saveRecordsToLocalIndex(@Nonnull URN urn, @Nonnull String aspect, @Nonnull String path,
    ...
    log.error("Calling saveRecordsToLocalIndex (a local secondary index related method) from EbeanLocalDAOv2,"
        + "which does not support local secondary index.");
  ...
  protected long saveSingleRecordToLocalIndex(@Nonnull URN urn, @Nonnull String aspect, @Nonnull String path,
      @Nonnull Object value) {
    log.error("Calling saveSingleRecordToLocalIndex (a local secondary index related method) from EbeanLocalDAOv2,"
        + "which does not support local secondary index.");
  ...
  Map<Class<? extends RecordTemplate>, LocalDAOStorageConfig.AspectStorageConfig> getStrongConsistentIndexPaths() {
    log.error("Calling getStrongConsistentIndexPaths (a local secondary index related method) from EbeanLocalDAOv2,"
        + "which does not support local secondary index.");
  ...
  public Map<AspectKey<URN, ? extends RecordTemplate>, Optional<? extends RecordTemplate>> get(
    ...
    // read records from old and new schemas
