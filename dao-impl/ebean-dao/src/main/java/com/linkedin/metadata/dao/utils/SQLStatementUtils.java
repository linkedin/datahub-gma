...
public class SQLStatementUtils {
  ...
  protected static String addTablePrefixToExpression(@Nonnull String tablePrefix,
    ...
    System.out.println("originColName: " + originColumnName);
    System.out.println("returnedExp: " + expression.replaceAll("(?<!\\.)(`?" + originColumnName + "`?)(\\s*)", "`" + tablePrefix + "`.$1$2"));
  ...
  protected static String parseLocalRelationshipField(
    ...
    if (field.isAspectField()) {
      ...
      System.out.println("indexedExpressionOrCol: " + indexedExpressionOrColumn);
