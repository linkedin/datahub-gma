...
public class EbeanLocalRelationshipQueryDAOTest {
  ...
  public void testFindOneRelationship(EbeanLocalDAO.SchemaConfig schemaConfig) throws Exception {
    ...
    List<ReportsTo> reportsToAlice = _localRelationshipQueryDAO.findRelationships(FooSnapshot.class,
        ...
        ReportsTo.class, new LocalRelationshipFilter().setCriteria(new LocalRelationshipCriterionArray()).setDirection(RelationshipDirection.OUTGOING), 0, 10);
  ...
  public void testFindOneRelationshipWithFilter(EbeanLocalDAO.SchemaConfig schemaConfig) throws Exception {
    ...
    List<ConsumeFrom> consumeFromSamza = _localRelationshipQueryDAO.findRelationships(BarSnapshot.class, filterUrn,
        FooSnapshot.class, new LocalRelationshipFilter().setCriteria(new LocalRelationshipCriterionArray()), ConsumeFrom.class,
  ...
  public void testFindOneRelationshipWithFilterWithEntityUrn(EbeanLocalDAO.SchemaConfig schemaConfig) throws Exception {
    ...
    if (schemaConfig != EbeanLocalDAO.SchemaConfig.OLD_SCHEMA_ONLY) {
      ...
      List<ConsumeFrom> consumeFromSamzaInNearline =
          _localRelationshipQueryDAO.findRelationships(barEntityUrn, filterUrn, fooEntityUrn, null, ConsumeFrom.class,
              filterRelationship, -1, -1);
  ...
  public void testFindOneRelationshipForCrewUsage(EbeanLocalDAO.SchemaConfig schemaConfig) throws Exception {
    ...
    List<OwnedBy> ownedByCrew1 = _localRelationshipQueryDAO.findRelationships(null, null, crewEntityUrn, filterUrn,
        OwnedBy.class, new LocalRelationshipFilter().setCriteria(new LocalRelationshipCriterionArray()).setDirection(RelationshipDirection.OUTGOING),
        -1, -1);
