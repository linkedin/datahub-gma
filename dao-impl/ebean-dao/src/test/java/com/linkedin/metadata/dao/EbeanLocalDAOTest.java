...
public class EbeanLocalDAOTest {
  ...
  public void testIn() {
    ...
    // TODO: this test fails for the new schema because there's no column in metadata_entity_foo testing table that
    // corresponds with this dynamically created aspect.
