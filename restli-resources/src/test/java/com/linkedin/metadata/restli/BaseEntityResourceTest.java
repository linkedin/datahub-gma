...
public class BaseEntityResourceTest extends BaseEngineTest {
  ...
  public void testGet() {
    ...
    AspectKey<FooUrn, AspectFooBaz> aspect4Key = new AspectKey<>(AspectFooBaz.class, urn, LATEST_VERSION);
    AspectKey<FooUrn, AspectFooBarBaz> aspect5Key = new AspectKey<>(AspectFooBarBaz.class, urn, LATEST_VERSION);
    AspectKey<FooUrn, AspectAttributes> aspect6Key = new AspectKey<>(AspectAttributes.class, urn, LATEST_VERSION);
    when(_mockLocalDAO.exists(urn)).thenReturn(true);
    when(_mockLocalDAO.get(new HashSet<>(Arrays.asList(aspect1Key, aspect2Key, aspect3Key, aspect4Key, aspect5Key, aspect6Key)))).thenReturn(
  ...
  public void testBatchGet() {
    ...
    AspectKey<FooUrn, AspectFooBaz> aspectFooBazKey1 = new AspectKey<>(AspectFooBaz.class, urn1, LATEST_VERSION);
    ...
    AspectKey<FooUrn, AspectFooBaz> aspectFooBazKey2 = new AspectKey<>(AspectFooBaz.class, urn2, LATEST_VERSION);
    ...
    when(_mockLocalDAO.get(ImmutableSet.of(aspectFooBarKey1, aspectFooBarKey2, aspectFooBazKey1, aspectFooBazKey2,
        aspectFooBarBazKey1, aspectFooBarBazKey2, aspectFooKey1, aspectBarKey1, aspectFooKey2, aspectBarKey2, aspectAttKey1, aspectAttKey2)))
  ...
  public void testGetSnapshotWithAllAspects() {
    ...
    AspectFooBaz fooBaz = new AspectFooBaz().setBars(new BarUrnArray(new BarUrn(1)));
    ...
    AspectKey<FooUrn, ? extends RecordTemplate> fooBazKey = new AspectKey<>(AspectFooBaz.class, urn, LATEST_VERSION);
    ...
    Set<AspectKey<FooUrn, ? extends RecordTemplate>> aspectKeys = ImmutableSet.of(fooKey, barKey, fooBarKey, fooBazKey, fooBarBazKey, attKey);
    when(_mockLocalDAO.get(aspectKeys)).thenReturn(ImmutableMap.of(fooKey, Optional.of(foo), barKey, Optional.of(bar),
        fooBarKey, Optional.of(fooBar), fooBazKey, Optional.of(fooBaz), fooBarBazKey, Optional.of(fooBarBaz), attKey, Optional.of(attributes)));
    ...
    assertEquals(aspects, ImmutableSet.of(foo, bar, fooBar, fooBaz, attributes));
  }
  ...
  public void testFilterFromIndexWithAspects() {
    ...
    when(_mockLocalDAO.getAspects(ImmutableSet.of(AspectFoo.class, AspectBar.class, AspectFooBar.class, AspectFooBaz.class,
        AspectFooBarBaz.class, AspectAttributes.class), indexFilter, null, urn1, 2))
