...
public class BaseEntitySimpleKeyResourceTest extends BaseEngineTest {
  ...
  public void testGet() {
    ...
    AspectKey<Urn, AspectFooBaz> aspect4Key = new AspectKey<>(AspectFooBaz.class, urn, LATEST_VERSION);
    AspectKey<Urn, AspectFooBarBaz> aspect5Key = new AspectKey<>(AspectFooBarBaz.class, urn, LATEST_VERSION);
    AspectKey<Urn, AspectAttributes> aspect6Key = new AspectKey<>(AspectAttributes.class, urn, LATEST_VERSION);

    when(_mockLocalDAO.exists(urn)).thenReturn(true);
    when(_mockLocalDAO.get(new HashSet<>(Arrays.asList(aspect1Key, aspect2Key, aspect3Key, aspect4Key, aspect5Key, aspect6Key))))
  ...
  public void testBatchGet() {
    ...
    AspectKey<Urn, AspectFooBaz> aspectFooBazKey1 = new AspectKey<>(AspectFooBaz.class, urn1, LATEST_VERSION);
    AspectKey<Urn, AspectFooBaz> aspectFooBazKey2 = new AspectKey<>(AspectFooBaz.class, urn2, LATEST_VERSION);
    ...
    when(_mockLocalDAO.get(ImmutableSet.of(aspectFooKey1, aspectBarKey1, aspectAttKey1, aspectFooKey2, aspectBarKey2,
        aspectAttKey2, aspectFooBarKey1, aspectFooBarKey2, aspectFooBazKey1, aspectFooBazKey2, aspectFooBarBazKey1, aspectFooBarBazKey2))).thenReturn(
  ...
  public void testGetSnapshotWithAllAspects() {
    ...
    AspectKey<Urn, ? extends RecordTemplate> fooBazKey = new AspectKey<>(AspectFooBaz.class, urn, LATEST_VERSION);
    ...
    Set<AspectKey<Urn, ? extends RecordTemplate>> aspectKeys = ImmutableSet.of(fooKey, barKey, fooBarKey, fooBazKey, fooBarBazKey, attKey);
    when(_mockLocalDAO.get(aspectKeys)).thenReturn(ImmutableMap.of(fooKey, Optional.of(foo), barKey, Optional.of(bar),
        fooBarKey, Optional.of(fooBar), fooBazKey, Optional.of(fooBaz), fooBarBazKey, Optional.of(fooBarBaz), attKey, Optional.of(att)));
    ...
    assertEquals(aspects, ImmutableSet.of(foo, bar, fooBar, fooBaz, att));
  }
